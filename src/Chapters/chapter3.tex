...
We have four sets of data which are from block size of
\(4\times4\), \(8\times8\), \(16\times16\) to \(32\times32\).
...
Hence only part of the visualizations of block size $8\times8$
are showing in this section.
...
Those discussions further convince the necessity of data 
