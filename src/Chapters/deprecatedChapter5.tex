% !TEX root = ../main.tex
\chapter{Evaluate the Learned Deep Model}\label{ch:chapter5ss} % For referencing the chapter elsewhere, use \ref{Chapter1}
%
%%----------------------------------------------------------------------------------------
%
...
%%----------------------------------------------------------------------------------------
%
\section{Evaluate the Deep Model trained using blocks of size 08x08}\label{sec:eval-eight}
\section{Evaluate the Deep Model trained using blocks of size 16x16}\label{sec:eval-sixteen}
\subsection{Evaluate the Deep Model on blocks of size 16x16}\label{subsec:eval-on-sixteen}
\subsection{Evaluate the Deep Model on blocks of size 32x32}\label{subsec:eval-on-thirty-two}
