...
our rescue.
The major different characteristics between Stereo display and
...
Figure~\ref{fig:wedgelet-partition} presents an real example of the wedgelet
partition from the depth map in Shark video sequence.
The small block highlighted by blue color amongst a large amount of blocks
