...
frame wherein the all intra configuration in HTM-16.2.
...
observed from the terminal (Linux/macOS) outputs or command line (Windows)
outputs.
An example of the encoding time for each view from the GhostTownFly sequence
is excerpt shown in Table~\ref{tab:autostereo-less-views-more-views}.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Table examples
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\begin{table}
