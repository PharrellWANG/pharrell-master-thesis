...
In particular, IMAX 3D has became the most popular one that offering
the immersing multimedia experiences around the world.
Special glasses are needed for watching the IMAX 3D movies.
The current 3D film industry is quite successful in terms of attracting
customers, however, it is not the end of the story.
Myopic people do not like to wear one more pair of glasses when
watching 3D movies.
Some people will even feel uncomfortable after wearing the 3D glasses for a
period of two hours.
Autostereoscopic technology~\parencite{RN153} is coming to rescue.
No glasses are needed if Autostereoscopic videos can
substitute the Stereoscopic videos.
The autostereoscopic multi-view display demands more
...
the depth maps, such as extremely sharp edges and large homogeneous
regions~\parencite{RN47}.
