...
In the ILSVRC-2015, Residual Neural Network (ResNet)~\parencite{RN67} with 152 layers
won the championships in all the five main tracks.
ResNet introduced a brand new notion named identity mapping in the
world of neural network structure.
Such kind of shortcut connection prevents the degradation of training accuracy
